...
var _default = (0, _helperPluginUtils.declare)((api, options) => {
  ...
  const compile = (path, uniqueId) => {
    ...
    const queryDocument = (0, _graphqlTag.default)(source); // If a document contains only one operation, that operation may be unnamed:
    ...
    const body = (0, _babelLiteralToAst.default)(strip ? (0, _graphql.stripIgnoredCharacters)(source) : queryDocument);
